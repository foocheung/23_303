# ------------------------------------------------------------------------------
# Title: Figure5E_center.R
# Description: This script reads light clone-level annotation 
...
# Plots are generated separately for light chains and saved as PDFs.
#
...
df<-read.csv("../../data/light_cdr3_fasta_with_annotation_hits.csv")
...
pdf("Figure5E_center.pdf", width = 15)
freq_plot3
dev.off()
