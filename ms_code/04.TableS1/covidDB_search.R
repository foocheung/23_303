# ------------------------------------------------------------------------------
# Title: covidDB_search.R
# Description: Search heavy/light chain CDR3 sequences from BEAM dataset against 
# CoV-AbDab to find known antigen-reactive clones and export matching details.  
#
